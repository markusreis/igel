        ...
        'searchRequest': [
            new EvaluationStep({
                ...
                fields: [
                    ...
                    new EvaluationField({
                        name: 'looking-for-doppel',
                        type: 'checkbox',
                        onError: '',
                        required: false,
                        label: 'Doppelhaushälfte oder Reihenhaus',
                    }),
                    new EvaluationField({
                        name: 'looking-for-buero',
                        type: 'checkbox',
                        onError: '',
                        required: false,
                        label: 'Büroräumlichkeiten',
                    }),
                ],
            }),
            new EvaluationStep({
                ...
                fields: [
                    new EvaluationField({
                        name: 'search-area-house',
                        onError: 'Bitte geben Sie eine Grundstücksfläche an',
                        regex: new RegExp("[0-9]{2,}"),
                        type: 'number',
                        label: 'Minimale Grundstücksfläche (m<sup>2</sup>)',
                    }),
                    new EvaluationField({
                        name: 'search-living-area-house',
                        onError: 'Bitte geben Sie eine Wohnfläche an',
                        regex: new RegExp("[0-9]{2,}"),
                        type: 'number',
                        label: 'Minimale Wohnfläche (m<sup>2</sup>)',
                    }),
                ],
            }),
            new EvaluationStep({
            ...
            new EvaluationStep({
                name: 'date',
                title: 'Wann wollen Sie kaufen?',
                fields: [
                    new EvaluationField({
                        name: 'search-when',
                        type: 'radio',
                        onError: 'Wann wollen sie kaufen?',
                        options: [
                            {name: 'binnen 6 Monaten'},
                            {name: 'binnen 12 Monaten'},
                            {name: 'binnen 24 Monaten'},
                            {name: 'Länger / unbekannt'},
                        ]
                    })
                ],
            }),
            new EvaluationStep({
                ...
                fields: [
                    new EvaluationField({
                        name: 'search-details',
                        type: 'text',
                        onError: 'Bitte geben Sie uns noch ein zwei Details...',
                        label: 'Wunschpreis und weitere Infos',
                    }),
                ]
            }),
            new EvaluationStep({
