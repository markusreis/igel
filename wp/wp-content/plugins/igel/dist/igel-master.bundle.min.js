...
},{"regenerator-runtime":"../node_modules/regenerator-runtime/runtime.js"}],"Sync.js":[function(require,module,exports) {
"use strict";
...
var Sync = /*#__PURE__*/function () {
  function Sync() {
    ...
    var syncButton = document.getElementById('igel-sync-button');
    ...
    this._dom.button.addEventListener('click', function (e) {
      return _this.run();
    });
  }
  ...
  (0, _createClass2.default)(Sync, [{
    ...
    key: "_fetch",
    value: function () {
      var _fetch2 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2(url) {
        var _this2 = this;
    ...
    key: "prepare",
    value: function () {
      var _prepare = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee3() {
        var _this3 = this;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 3;
                return this._fetch("".concat(this._config.apiBase, "sync/prepare?api_token=").concat(this._config.token));
              ...
              case 6:
                ...
                if (this._state.toDownload.immo > 0 || this._state.toDownload.user > 0) {
                  setTimeout(function () {
                    return _this3.downloadNextImage();
                  }, 50);
                } else {
                  this.finalize();
                }
    ...
    key: "downloadNextImage",
    value: function () {
      var _downloadNextImage = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee4() {
        var _this4 = this;

        var body, toDownloadImmo, toDownloadUser, p;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 3;
                return this._fetch("".concat(this._config.apiBase, "sync/download-media?api_token=").concat(this._config.token));
              ...
              case 6:
                toDownloadImmo = body.realtyToDownload.length;
                toDownloadUser = body.userToDownload.length;
                ...
                if (this._state.toDownload.total > 0) {
                  p = Math.max(0, Math.min(1, this._state.toDownload.didDownload / this._state.toDownload.total));
                  this._dom.progressBar.style.width = p * 100 + '%';
                }

                if (this._state.toDownload.immo > 0 || this._state.toDownload.user > 0) {
                  setTimeout(function () {
                    return _this4.downloadNextImage();
                  }, 50);
                } else {
                  this.finalize();
                }
      ...
      function downloadNextImage() {
        return _downloadNextImage.apply(this, arguments);
      }
    ...
    value: function finalize() {
      ...
      setTimeout(function () {
        _this5._dom.button.style.background = '#2271b1';
        _this5._dom.button.innerText = _this5._config.buttonDefaultText;
        _this5._dom.progressBar.style.display = 'none';
        _this5._dom.progressBar.style.widht = '0%';
        setTimeout(function () {
          _this5._dom.progressBar.style.display = 'block';
          _this5._dom.progressBar.style.widht = '0%';
        }, 200);
      }, 1000);
    }
    ...
    key: "flashNumber",
    value: function flashNumber(node, no) {
...
},{"./Sync":"Sync.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/igel-master.bundle.min.js.map